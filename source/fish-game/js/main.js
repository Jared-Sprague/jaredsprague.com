...
class FishSprite extends Sprite {
    ...
    setImagePath() {
        this.img_path = 'assets/fish_' + this.type + '_' + (this.direction == LEFT ? 'left' : 'right') + '.png';
    }
...
class HandSprite extends Sprite {
    constructor() {
        ...
        // hand defaults
        this.img_path = 'assets/hand.png';
        this.img_height = 299;
        this.img_width = 282;

        this.recentSharkBite = false;
        this.img_red_path = 'assets/hand_red.png';
        this.img_hand_worm_path = 'assets/hand_worm.png';
        this.img_red = null;
...
class ChestSprite extends Sprite {
    constructor() {
        ...
        this.img_path = 'assets/chest.png';
        this.img_height = 70;
        this.img_width = 70;
    }
}
...
class fish {
    constructor() {
        ...
        // load images
        this.water_img = loadImage("assets/underwater1.jpg");
        ...
        this.coin_img = loadImage("assets/coin.png");
        this.chest.img = loadImage(this.chest.img_path);
        this.chest.x = (width / 2) - 150;
        this.chest.y = 5;

        // load sounds
        sound_underwater = loadSound('assets/sounds/underwater_amp.ogg');
        sound_bite = loadSound('assets/sounds/bite.ogg');
        sound_scream = loadSound('assets/sounds/whscream.ogg');
        sound_coin = loadSound('assets/sounds/coin.ogg');
        sound_1up = loadSound('assets/sounds/level_up.ogg');
        sound_over9000 = loadSound('assets/sounds/over9000.ogg');
        sound_cheer = loadSound('assets/sounds/cheer.ogg');
